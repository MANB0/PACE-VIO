#!/usr/bin/env python3
"""Run the missing full normal-noise Direct-UVD U1 rectangle and straight replays."""
...
VARIANT = "vio_two_state_direct_uvd_u1_standard_full"

# Circle already exists in Results/circle_normal_noise_direct_uvd_u1_full_20260716.
SCENES = {
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="CPU thread limit inherited by each concurrent replay process.",
    )
...
def write_monitor_files(
    ...
    *,
    ...
    with (result_root / "u1_missing_scenes_live_progress.csv").open(
    ...
    (result_root / "u1_missing_scenes_run_status.json").write_text(
...
def main() -> int:
    ...
    monitor_log = result_root / "u1_missing_scenes_monitor.log"
    ...
    runner_log = result_root / "u1_missing_scenes_runner.log"
