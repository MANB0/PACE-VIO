#!/usr/bin/env python3
"""Serve the pending manual-launch panel for the prepared rectangle full run."""
...
LAUNCH_SCRIPT = WORKDIR / "Scripts" / "run_rectangle_bias_no_noise_two_state_standard_full.sh"
