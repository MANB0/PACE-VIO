#!/usr/bin/env python3
"""
V3b++ Phase 1b Experiment B: FD-E grace=30 + CP-B-FD-only (shortened FD cooldown).

Config: Rule B VC + FD-E grace=30 + FD cooldown=30.

Usage:
    cd /home/admin1/macvo-dev
    conda activate macvo
    python Scripts/run_v3bpp_phase1b_fd_e_plus_cpb_fdonly.py
"""
...
TRIALS = 3
RESULT_ROOT = WORKDIR / "Results" / "v3bpp_phase1b_fd_e_plus_cpb_fdonly_5scene_3x"
...
def main():
    ...
    print("="*70)
    print("  V3b++ Phase 1b Experiment B: FD-E grace=30 + FD cooldown=30")
    print(f"  Total: {total} runs")
    print("="*70)

    tmpdir=Path(tempfile.mkdtemp(prefix="v3bpp_ph1b_B_"))
    ...
    args_base=[
        ...
        "--v3b-fd-grace-enabled","--v3b-fd-grace-period","30",
        "--v3b-fd-cooldown","30",
    ]
